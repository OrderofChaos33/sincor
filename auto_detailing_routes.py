...
def add_auto_detailing_routes(app):
    ...
    def book_download():
        ...
        try:
            ...
            # In production, you'd save to database and trigger email sequence
        ...
        <div class="max-w-7xl mx-auto px-4 py-4">
            <div class="flex justify-between items-center">
                <div class="flex items-center">
                    ...
                    <span class="ml-2 text-sm text-gray-500">Auto Detailing Authority</span>
                </div>
                ...
                <div class="bg-white p-8 rounded-xl shadow-2xl">
                    ...
                    <div class="text-center mb-6">
                        <div class="flex items-center justify-center space-x-2 mb-2">
                            <span class="text-3xl font-bold text-blue-600">$297</span>
                            <span class="text-lg text-gray-400 line-through">$327</span>
                            <span class="bg-red-500 text-white px-2 py-1 rounded text-sm">SAVE $30</span>
                        </div>
                        <div class="text-sm text-gray-600">First month $1 trial, then $297/month</div>
                    </div>
    ...
    <section class="py-16 bg-blue-900 text-white">
        <div class="max-w-4xl mx-auto px-4 text-center">
            ...
            <p class="mt-4 text-blue-200 text-sm">
                $1 first month • Includes $29.97 book FREE • Cancel anytime
            </p>
        </div>
    </section>
</body>
    ...
    <div class="max-w-2xl mx-auto py-12 px-4">
        <div class="bg-white rounded-lg shadow-lg p-8">
            ...
            <div class="border-b pb-6 mb-6">
                ...
                <div class="text-sm text-gray-500">First month $1, then ${{ "%.0f"|format(plan.price/100) }}/month</div>
...
<html>
<head>
    <title>FREE: From $0 to Six Figures in Auto Detailing</title>
    <link href="https://cdn.jsdelivr.net/npm/tailwindcss@2.2.19/dist/tailwind.min.css" rel="stylesheet">
</head>
<body class="bg-gray-50">
    <div class="max-w-4xl mx-auto py-12 px-4">
        <div class="bg-white rounded-xl shadow-lg p-8">
            <div class="grid md:grid-cols-2 gap-8 items-center">
                <!-- Left: Book -->
                <div class="text-center">
                    <div class="w-64 h-80 bg-gradient-to-br from-blue-600 to-purple-600 rounded-lg mx-auto mb-6 flex items-center justify-center">
                        <div class="text-white text-center">
                            <div class="text-6xl mb-4">📖</div>
                            <div class="text-lg font-bold leading-tight">FROM $0 TO<br>SIX FIGURES<br><br>AUTO DETAILING<br>BUSINESS</div>
                        </div>
                    </div>
                ...
                <div>
                    <h1 class="text-3xl font-bold text-gray-900 mb-4">
                        Get My Complete Auto Detailing Business Guide FREE
                    </h1>
                    
                    <div class="space-y-3 mb-6">
                        <div class="flex items-center">
                            <span class="text-green-500 mr-3">✓</span>
                            <span>How to start with $0 and scale to six figures</span>
                        </div>
                        <div class="flex items-center">
                            <span class="text-green-500 mr-3">✓</span>
                            <span>Customer acquisition strategies that work</span>
                        </div>
                        <div class="flex items-center">
                            <span class="text-green-500 mr-3">✓</span>
                            <span>Pricing strategies for maximum profit</span>
                        </div>
                        <div class="flex items-center">
                            <span class="text-green-500 mr-3">✓</span>
                            <span>Systems to automate your business</span>
                        </div>
                    </div>
