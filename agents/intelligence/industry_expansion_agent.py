    ...
    def _load_industry_configs(self) -> Dict[str, IndustryConfig]:
        ...
        industries = {
            ...
            "landscaping": IndustryConfig(
                name="Landscaping",
                search_terms=["landscaping", "lawn care", "tree service", "garden maintenance"],
                business_type="landscaping",
                market_size_estimate=400000,
                avg_revenue_estimate=80000,
                seasonality="seasonal",
                primary_personas=["business_owner", "crew_leader"],
                pain_points=["weather_dependent", "seasonal_income", "equipment_maintenance", "labor_management"],
                service_keywords=["mowing", "trimming", "planting", "irrigation", "hardscaping"],
                competition_level="high",
            ...
            "roofing_contractors": IndustryConfig(
                name="Roofing Contractors",
                search_terms=["roofing contractor", "roof repair", "roof replacement", "roofer"],
                business_type="roofing_contractors",
                market_size_estimate=100000,
                avg_revenue_estimate=500000,
                seasonality="weather_dependent",
                primary_personas=["business_owner", "project_manager"],
                pain_points=["weather_delays", "material_costs", "insurance_claims", "safety_compliance"],
                service_keywords=["repair", "replacement", "inspection", "storm damage", "insurance"],
                competition_level="medium",
                digital_adoption="low"
            ),
            
            "cleaning_services": IndustryConfig(
                name="Cleaning Services",
                search_terms=["cleaning service", "janitorial", "office cleaning", "house cleaning"],
                business_type="cleaning_services",
                market_size_estimate=200000,
                avg_revenue_estimate=100000,
                seasonality="year_round",
                primary_personas=["business_owner", "facility_manager"],
                pain_points=["staff_turnover", "supply_costs", "quality_consistency", "scheduling"],
                service_keywords=["cleaning", "sanitizing", "maintenance", "commercial", "residential"],
                competition_level="high",
                digital_adoption="medium"
            ),
            
            "pool_services": IndustryConfig(
                name="Pool Services",
                search_terms=["pool service", "pool cleaning", "pool maintenance", "pool repair"],
                business_type="pool_services",
                market_size_estimate=50000,
                avg_revenue_estimate=120000,
                seasonality="seasonal",
                primary_personas=["business_owner", "pool_tech"],
                pain_points=["seasonal_business", "chemical_costs", "equipment_failure", "customer_education"],
                service_keywords=["cleaning", "maintenance", "repair", "chemicals", "equipment"],
